...
public class Launcher extends Application {
	...
	private ArrayList<Body> createBodies() {
		...
		Body matDot_end = new RoughBody(1, new RadiusVector(320, 550), 0);
		Body matDot_anotherEnd = new RoughBody(1, new RadiusVector(450, 600), 0);
		Body matDot_yetAnotherEnd = new RoughBody(100, new RadiusVector(480, 650), 0);
		Body matDot_yetAnotherEnd2 = new RoughBody(100, new RadiusVector(480, 700), 0);
		Body matDot_yetAnotherEnd3 = new RoughBody(1, new RadiusVector(450, 750), 0);
		...
		Body matDot_tStart = new RoughBody(0.1, new RadiusVector(400, 780), 0);
...
//		Body matDot_tYetAnotherEnd = new RoughBody(0.1, new RadiusVector(300, 700), 0);
